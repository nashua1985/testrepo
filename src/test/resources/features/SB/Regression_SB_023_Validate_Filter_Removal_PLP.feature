Feature: Regression_SB_023_Validate_Filter_Removal_PLP

@SB_Regression
@SB_023

  Scenario Outline: Regression_SB_023_Validate_Filter_Removal_PLP
  ...
  Scenario Outline: Regression_SB_023_Validate_Filter_Removal_PLP_GG
