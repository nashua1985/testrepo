Feature: Regression_CHECKOUT_014_Payment_Form_Validations_CC_Number
  ...
  @Regression
  @CHECKOUT_014
  Scenario: Regression_CHECKOUT_014_Payment_Form_Validations_CC_Number
	...
	And we enter "4111111111111112" in the Credit Card Number field
	And we enter "12/24" in the Exp. date field
	...
	@Regression
	@CHECKOUT_DELTA_014
	Scenario: Regression_DELTA_CHECKOUT_014_Payment_Form_Validations_CC_Number
