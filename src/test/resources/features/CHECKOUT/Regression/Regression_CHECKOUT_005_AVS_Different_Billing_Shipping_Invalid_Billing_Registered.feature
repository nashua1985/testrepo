Feature: Regression_CHECKOUT_005_AVS_Different_Billing_Shipping_Invalid_Billing_Registered
  ...
  @Regression
  @CHECKOUT_005
  Scenario: Regression_CHECKOUT_005_AVS_Different_Billing_Shipping_Invalid_Billing_Registered
	...
	And we change street address "1 Court St" as billing address
	...
	@Regression
	@CHECKOUT_DELTA_005
	Scenario: Regression_DELTA_CHECKOUT_005_AVS_Different_Billing_Shipping_Invalid_Billing_Registered
