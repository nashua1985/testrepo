Feature: Regression_CHECKOUT_026_Payments_PayPal
  ...
  @Regression
  @CHECKOUT_026
  Scenario: Regression_CHECKOUT_026_Payments_PayPal
	...
	And we click PayPal Checkout button
  	And we wait for 3 seconds
	Then we should see "Pay with PayPal"
	#indicating paypal successfully launched

	@CHECKOUT_DELTA
	@Regression
	@CHECKOUT_DELTA_026
	Scenario: Regression_DELTA_CHECKOUT_026_Payments_PayPal
