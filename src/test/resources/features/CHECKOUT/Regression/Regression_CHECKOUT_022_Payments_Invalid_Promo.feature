Feature: Regression_CHECKOUT_022_Payments_Invalid_Promo
  ...
  @Regression
  @CHECKOUT_022
  Scenario: Regression_CHECKOUT_022_Payments_Invalid_Promo
	...
	And we enter "DSGINVALIDPROMO2021" in the promo code field
	And we click Apply Code
	Then we should see "Promo code DSGINVALIDPROMO2021 does not match an active promotion."

	@CHECKOUT_DELTA
	@Regression
	@CHECKOUT_DELTA_022
	Scenario: Regression_DELTA_CHECKOUT_022_Payments_Invalid_Promo
