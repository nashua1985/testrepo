Feature: Regression_CHECKOUT_021_Info_Retention_EDD
  ...
  @Regression
  @CHECKOUT_021
  Scenario: Regression_CHECKOUT_021_Info_Retention_EDD
	...
	And we remember EDD for shipping containers
	...
	And we validate EDD for shipping containers


	@CHECKOUT_DELTA
	@Regression
	@CHECKOUT_DELTA_021
	Scenario: Regression_DELTA_CHECKOUT_021_Info_Retention_EDD
