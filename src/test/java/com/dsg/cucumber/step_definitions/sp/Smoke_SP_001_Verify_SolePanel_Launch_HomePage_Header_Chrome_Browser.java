...
public class Smoke_SP_001_Verify_SolePanel_Launch_HomePage_Header_Chrome_Browser {

    private static final Logger logger = Logger.getLogger(Smoke_SP_001_Verify_SolePanel_Launch_HomePage_Header_Chrome_Browser.class);
